package md5782367308113d09decf7b165ec3d9b4f;


public class GeolocatorLocationListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("XPlat.Device.Geolocation.GeolocatorLocationListener, XPlat.Device.Geolocation.Droid", GeolocatorLocationListener.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == GeolocatorLocationListener.class)
			mono.android.TypeManager.Activate ("XPlat.Device.Geolocation.GeolocatorLocationListener, XPlat.Device.Geolocation.Droid", "", this, new java.lang.Object[] {  });
	}
